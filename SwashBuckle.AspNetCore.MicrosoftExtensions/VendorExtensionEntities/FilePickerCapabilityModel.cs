...
/// </summary>
public class FilePickerCapabilityModel: IOpenApiExtension {
    /// <summary>
    ...
    public void Write(IOpenApiWriter writer, OpenApiSpecVersion specVersion) {
        ...
        if (this.Open is not null) { 
            ...
            this.Open.Write(writer, specVersion);
        }
        if (this.Browse is not null) {
            writer.WritePropertyName("browse");
            this.Browse.Write(writer, specVersion);
        }
        writer.WriteProperty("value-title", this.ValueTitle);
        writer.WriteProperty("value-folder-property", this.ValueFolderProperty);
        writer.WriteProperty("value-media-property", this.ValueMediaProperty);
